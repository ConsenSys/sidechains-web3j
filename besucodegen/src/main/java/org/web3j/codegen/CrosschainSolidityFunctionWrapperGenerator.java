...
public class CrosschainSolidityFunctionWrapperGenerator extends FunctionWrapperGenerator {
    ...
    protected CrosschainSolidityFunctionWrapperGenerator(
            File binFile,
            File abiFile,
            File destinationDir,
            String contractName,
    ...
    public final void generate() throws IOException, ClassNotFoundException {
        ...
        if (functionDefinitions.isEmpty()) {
            ...
            new CrosschainSolidityFunctionWrapper(
                            useJavaNativeTypes,
                            useJavaPrimitiveTypes,
