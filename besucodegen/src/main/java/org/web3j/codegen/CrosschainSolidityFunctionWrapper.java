...
public class CrosschainSolidityFunctionWrapper extends SolidityFunctionWrapper {
    ...
    //            TypeName mapStringString = ParameterizedTypeName.get(mapType, stringType,
    // stringType);
    ...
    //    }
    //
    //    String addParameters(MethodSpec.Builder methodBuilder, List<AbiDefinition.NamedType>
    // namedTypes)
    //            throws ClassNotFoundException {
    //
    ...
    //        } else {
    //            return Collection.join(inputParameterTypes, ", ", parameterSpec ->
    // parameterSpec.name);
    //        }
    //    }
    //
    ...
    //            List<TypeName> typeNames = ((ParameterizedTypeName)
    // parameterSpec.type).typeArguments;
    //            if (typeNames.size() != 1) {
    ...
    //                    List<TypeName> typeArguments = ((ParameterizedTypeName)
    ...
    //            reporter.report(
    //                    String.format(
    //                            "Definition of the function %s returns a value but is not defined
    // as a view function. "
    //                                    + "Please ensure it contains the view modifier if you want
    ...
    //            String className,
    //            List<CrosschainSolidityFunctionWrapper.NamedTypeName> indexedParameters,
    //            List<CrosschainSolidityFunctionWrapper.NamedTypeName> nonIndexedParameters) {
    //
    ...
    //        for (CrosschainSolidityFunctionWrapper.NamedTypeName namedType :
    //                indexedParameters) {
    ...
    //            throws ClassNotFoundException {
    //
    //        String generatedFunctionName = Strings.lowercaseFirstLetter(functionName) +
    // "EventFlowable";
    ...
    //    }
    //
    //    MethodSpec buildDefaultEventFlowableFunction(String responseClassName, String
    // functionName) {
    //
    //        String generatedFunctionName = Strings.lowercaseFirstLetter(functionName) +
    // "EventFlowable";
    ...
    //                .addStatement("$1T typedResponse = new $1T()", ClassName.get("",
    // responseClassName))
    //                .addCode(
    //                        buildTypedResponse(
    //                                "typedResponse", indexedParameters, nonIndexedParameters,
    // false))
    ...
    //        String responseClassName = Strings.capitaliseFirstLetter(functionName) +
    // "EventResponse";
    //
    ...
    //            builder.addStatement(
    //                    "$L.$L = ($T) eventValues.getNonIndexedValues().get($L)" +
    // nativeConversion,
    //                    objectName,
    ...
    //                    convertTo =
    //                            ParameterizedTypeName.get(classList,
    ...
    //                TypeSpec.anonymousClassBuilder("")
    //                        .addSuperinterface(
    //                                ParameterizedTypeName.get(ClassName.get(Callable.class),
    // tupleType))
    //                        .addMethod(
    //                                MethodSpec.methodBuilder("call")
    //                                        .addAnnotation(Override.class)
    ...
    //
    //        methodBuilder.addStatement(
    //                "return new $T(function,\n$L)", buildRemoteFunctionCall(tupleType),
    // callableType);
    //    }
    //
